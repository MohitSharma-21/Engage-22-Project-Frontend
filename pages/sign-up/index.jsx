...
export default function SignUp() {
  ...
  return (
    ...
    >
      {modalIsOpen == false && (
        <div
          className={`${styles.main} sm:w-11/12 md:w-3/4 w-1/2 h-3/5 flex justify-center items-center rounded-lg`}
        >
          <div
          ...
          >
            ...
            <div className={`sm:w-3/4 p-1 w-2/5 flex flex-col`}>
              <input
                className={`sm:w-11/12 border-b-2 border-solid border-white m-1 mt-4 p-2 outline-none bg-transparent text-xl `}
                id="inputUsername"
                type="text"
